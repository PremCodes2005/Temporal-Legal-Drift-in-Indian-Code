...
`check-gates` is the executable Phase 0–2 engineering acceptance check used by CI. It reports qualified research/legal review separately; passing software checks never fabricates human approval.
